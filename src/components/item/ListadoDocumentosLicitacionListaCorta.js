...
export default function ListadoDocumentosLicitacionListaCorta(props) {
    ...
    const getFiles = () => {
        axios.post(props.url + "api/get-plan-items-licitacion-files-lista-corta",
            {
                id: props.id
            }
        )
        ...
        swal({
            ...
            .then((certifico) => {
                if (certifico) {
                    ...
                    axios.post(props.url + "api/delete-item-licitacion-file-lista-corta",
                        {
                            id: id,
                            user
                        }
