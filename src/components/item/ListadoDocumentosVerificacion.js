...
export default function ListadoDocumentosVerificacion(props) {
    ...
    const getFiles = () => {
        axios.post(props.url + "api/get-plan-items-verificacion-files",
            {
                id: props.id
            }
        )
        ...
        swal({
            ...
            .then((certifico) => {
                if (certifico) {
                    ...
                    axios.post(props.url + "api/delete-item-verificacion-file",
                        {
                            id: id,
                            user
                        }
    ...
    return (
        <div className="row flex">
            <h3 className="full">
                Listado de documentos de verificación
            </h3>
            {files}
        </div>
    );
