...
export default function ListadoDocumentosEnmienda(props) {
    ...
    const getFiles = () => {
        axios.post(props.url + "api/get-plan-items-enmienda-files",
            {
                id: props.id
            }
        )
        ...
        swal({
            ...
            .then((certifico) => {
                if (certifico) {
                    ...
                    axios.post(props.url + "api/delete-item-enmienda-file",
                        {
                            id: id,
                            user
                        }
    ...
    return (
        <div className="row flex">
            <h3 className="full">
                Listado de documentos de enmienda cargados
            </h3>
            {files}
        </div>
    );
