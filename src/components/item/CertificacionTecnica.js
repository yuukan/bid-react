...
export default function CertificacionTecnica(props) {
    ...
    const approve = () => {
        ...
        if (state.checkedA) {
            axios.post(props.url + "api/certificacion-tecnica",
                {
    ...
    const reject = () => {
        ...
        swal({
            ...
            if (razon) {
                axios.post(props.url + "api/rechazo-certificacion-tecnica",
                    {
                        id: props.match.params.id,
                        user,
                        razon
