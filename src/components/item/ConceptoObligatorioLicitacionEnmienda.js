...
export default function ConceptoObligatorioLicitacionEnmienda(props) {
    ...
    const approve = () => {
        ...
        if (state.checkedA && state.checkedB && state.checkedC && state.checkedD && state.checkedE && state.checkedF) {
            swal({
                ...
                if (razon) {
                    setDisabled(true);
                    axios.post(props.url + "api/si-concepto-obligatorio-item-licitacion-enmienda",
                        {
                            id: props.match.params.id,
                            user,
                            razon
    ...
    const reject = () => {
        ...
        swal({
            ...
            if (razon) {
                setDisabled(true);
                axios.post(props.url + "api/no-concepto-obligatorio-item-licitacion-enmienda",
                    {
                        id: props.match.params.id,
                        user,
                        razon
    ...
    return (
        <div className="crear-container">
            ...
            <div className="sub-container space-bellow">
                <div className="row">
                    <h1>
                        Concepto Obligatorio Licitación Enmienda
                    </h1>
                    {
                        description!=="" ?
                        (
