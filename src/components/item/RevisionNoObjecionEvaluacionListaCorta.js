...
export default function RevisionNoObjecionEvaluacionListaCorta(props) {
    ...
    const deny = () => {
        ...
        swal({
            ...
            if(razon){
                axios.post(props.url + "api/denegar-no-objecion-lista-corta",
                    {
                        id: props.match.params.id,
                        user,
                        razon
    ...
    const approve = () => {
        let user = localStorage.getItem("bidID");
        if (state.checkedA) {           
            axios.post(props.url + "api/revision-no-objecion-evaluacion-lista-corta",
                {
                    id: props.match.params.id,
                    user
                }
    ...
    return (
        <div className="crear-container">
            <div className="sub-container space-bellow">
                <h1>
                   Revisión de no objecion evaluación lista corta
                </h1>
                {
