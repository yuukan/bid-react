...
export default function ListadoDocumentosVerificacionListaCorta(props) {
    ...
    const getFiles = () => {
        axios.post(props.url + "api/get-plan-items-verificacion-files-lista-corta",
            {
                id: props.id
            }
        )
        ...
        swal({
            ...
            .then((certifico) => {
                if (certifico) {
                    ...
                    axios.post(props.url + "api/delete-item-verificacion-file-lista-corta",
                        {
                            id: id,
                            user
                        }
