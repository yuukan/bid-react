...
export default function ListadoDocumentosGarantia(props) {
    ...
    const getFiles = () => {
        axios.post(props.url + "api/get-documentos-garantia",
            {
                id: props.id
            }
        )
        ...
        swal({
            ...
            .then((certifico) => {
                if (certifico) {
                    ...
                    axios.post(props.url + "api/delete-item-garantia-file",
                        {
                            id: id,
                            user
                        }
