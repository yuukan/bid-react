...
export default function InicioEvaluacionListaCorta(props) {
    ...
    const complete_info = () => {
        swal({
            ...
            .then((certifico) => {
                if (certifico) {
                    let user = localStorage.getItem("bidID");
                    axios.post(props.url + "api/iniciar-evaluacion-lista-corta",
                        {
                            id: props.match.params.id,
                            user
                        }
    ...
    const verify = () => {
        ...
        swal({
            ...
            if (razon) {
                axios.post(props.url + "api/verificar-evaluacion-lista-corta",
                    {
                        id: props.match.params.id,
                        user,
                        razon
    ...
    return (
        <div className="crear-container">
            <div className="sub-container">
                <h1>
                    Inicio de Evaluación lista corta
                </h1>
                <h2>
