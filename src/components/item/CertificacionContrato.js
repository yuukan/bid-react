...
export default function CertificacionContrato(props) {
    ...
    const approve = () => {
        ...
        swal({
            title: "¡Certificación!",
            text: "Yo certifico que este contrato consta con todos los requisitos.",
            icon: "warning",
            ...
            .then((certifico) => {
                if (certifico) {
                    setDisabled(true);
                    axios.post(props.url + "api/certificacion-contrato-jefe-equipo",
                        {
                            id: props.match.params.id,
                            user
                        }
    ...
    return (
        <div className="crear-container">
            <div className="sub-container">
                <h1>
                    Certificación de contrato jefe de equipo
                </h1>
