...
import ListadoDocumentosLicitacionListaCorta from './ListadoDocumentosLicitacionListaCorta';

export default function LlamadoLicitacionListaCorta(props) {
    ...
    useEffect(() => {
        axios.post(props.url + "api/get-activity-info",
            ...
            .then(function (response) {
                ...
                setState2({ ...state2, nog: response.data[0].nog_lista_corta || "", recepcion_ofertas: response.data[0].recepcion_ofertas_lista_corta || "" });
            })
    ...
    const onSubmit = (e) => {
        ...
        if (pod) {
            ...
            axios.post(props.url + "api/upload-item-licitacion-documents-lista-corta", data)
                .then(function () {
                    setDisabled(false);
    ...
    const complete_info = () => {
        console.log(state2);
        if(state2.nog==="" || state2.nog===null || state2.recepcion_ofertas=== null || state2.recepcion_ofertas=== ""){
            ...
            swal({
                ...
                .then((certifico) => {
                    if (certifico) {
                        let user = localStorage.getItem("bidID");
                        axios.post(props.url + "api/completar-archivos-licitacion-item-lista-corta",
                            {
                                id: props.match.params.id,
                                user,
                                nog: s.nog,
    ...
    switch(activity.cs_estado_proceso_id){
        case(30):
            description = activity.rechazo_certificacion_director_lista_corta;
            break;
        case(32):
            description = activity.rechazo_certificacion_tecnica_licitacion_lista_corta;
            break;
        case(34):
            description = activity.rechazo_concepto_obligatorio_licitacion_lista_corta;
            break;
        case(36):
            description = activity.rechazo_final_licitacion_lista_corta;
            break;
        default:
            break;
    }
    ...
    return (
        <div className="crear-container">
            <div className="sub-container">
                <h1>
                    Llamado a licitación lista corta
                </h1>
                {
                    description!=="" ?
                    (
                ...
                <form onSubmit={onSubmit}>
                    ...
                    <div className="hero space-bellow">
                        <div className="row">
                            <div className="row">
                                <ListadoDocumentosLicitacionListaCorta
                                        id={props.match.params.id}
