...
export default function EvaluacionOfertasListaCorta(props) {
        ...
        swal({
            ...
            .then((certifico) => {
                if (certifico) {
                    ...
                    axios.post(props.url + "api/evaluacion-oferta-lista-corta",
                        data
                    )
                        .then(function () {
                            window.history.back();
    ...
    return (
        <div className="crear-container">
            <div className="sub-container">
                <h1>
                    Evaluación de expresiones de interés lista corta
                </h1>
