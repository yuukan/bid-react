...
export default function AprobacionFinalLiciatacion(props) {
    ...
    const approve = () => {
        ...
        if (state.checkedA) {
            axios.post(props.url + "api/aprobacion-final-item-licitacion",
                {
    ...
    const reject = () => {
        ...
        swal({
            ...
            if (razon) {
                axios.post(props.url + "api/rechazo-final-item-licitacion",
                    {
                        id: props.match.params.id,
                        user,
                        razon
