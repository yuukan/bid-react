...
export default function AprobacionJefeEquipoBanco(props) {
    ...
    const approve = () => {
        ...
        if (state.checkedA && state.checkedB && state.checkedC && state.checkedD && state.checkedE && state.checkedF) {
            setDisabled(true);
            axios.post(props.url + "api/aprobacion-jefe-equipo-banco",
                {
    ...
    const reject = () => {
        ...
        swal({
            ...
            if (razon) {
                setDisabled(true);
                axios.post(props.url + "api/rechazo-jefe-equipo-banco",
                    {
                        id: props.match.params.id,
                        user,
                        razon
    ...
    return (
        <div className="crear-container">
            ...
            <div className="sub-container space-bellow">
                <div className="row">
                    <h2>
                        Aprobación del Jefe de Equipo del Banco
                    </h2>
                    <div className="full">
                    ...
                    <div className="full">
                        <button type="button" className="save" onClick={approve} disabled={disabled}>
                            <FontAwesomeIcon icon="save" /> Enviar a Concepto obligatorio
                            <LinearProgress />
                        </button>
